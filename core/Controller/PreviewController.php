...
class PreviewController extends Controller {
	 ...
	 * @return FileDisplayResponse<Http::STATUS_OK, string, array{}>|DataResponse<Http::STATUS_BAD_REQUEST|Http::STATUS_FORBIDDEN|Http::STATUS_NOT_FOUND, \stdClass, array{}>
	 *
